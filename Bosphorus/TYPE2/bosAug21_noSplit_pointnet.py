...
train_points, train_labels = load_h5(os.path.join(path, 'data_aug21_random_bos_neutral_no_split.h5'))
print(train_labels)
...
for i in range(1,2):
    if i!=0: 
    	w_name = 'bosPointnetNeutralAug21_noSplit'
...
with open('bos_neutral_trainAug21_noSplit.pkl', 'wb') as f:
	pickle.dump(train_features, f)

with open('bos_neutral_testAug21_noSplit.pkl', 'wb') as f:
	pickle.dump(test_features, f)

with open('bos_neutral_trainlAug21_noSplit.pkl', 'wb') as f:
	pickle.dump(train_labels_r, f)

with open('bos_neutral_testlAug21_noSplit.pkl', 'wb') as f:
