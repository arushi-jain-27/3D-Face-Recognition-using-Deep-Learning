...
def plot_far_frr(pred,labels):
        ...
        plt.ylabel('FAR/FRR')
        plt.title('FAR FRR curve for Bosphrous Neutral Dataset')
        plt.legend(loc='best')
        #plt.ylim(0,0.01)
        #plt.xlim(-0.001,1.001)
        plt.grid(True)
        plt.savefig("far_frr_bos_21.png")
...
def plot_roc(y_test,y_score):
	...
	plt.title('ROC curve: Bosphrous Neutral Aug21 NoSplit')
	plt.legend(loc='best')
	plt.savefig("roc_bos_neutralAug21_noSplit.png")
...
with open('bos_neutral_trainAug21_noSplit.pkl', 'rb') as f:
	train_points = pickle.load(f)

with open('bos_neutral_testAug21_noSplit.pkl', 'rb') as f:
	test_points = pickle.load(f)

with open('bos_neutral_trainlAug21_noSplit.pkl', 'rb') as f:
	train_labels = pickle.load(f)

with open('bos_neutral_testlAug21_noSplit.pkl', 'rb') as f:
...
for i in range(0,5):
    if i!=0: 
    	w_name = 'neutral_test_trainbosAug21_noSplit'
    	model.load_weights(w_name, by_name=True)
