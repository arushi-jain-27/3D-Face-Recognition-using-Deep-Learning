...
train_points, train_labels = load_h5(os.path.join(path, 'data_aug_random_bos_neutral.h5'))
print(train_labels)
...
with open('bos_neutral_train.pkl', 'wb') as f:
	pickle.dump(train_features, f)

with open('bos_neutral_test.pkl', 'wb') as f:
	pickle.dump(test_features, f)

with open('bos_neutral_trainl.pkl', 'wb') as f:
	pickle.dump(train_labels_r, f)

with open('bos_neutral_testl.pkl', 'wb') as f:
