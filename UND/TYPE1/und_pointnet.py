...
train_points, train_labels = load_h5(os.path.join(path, 'data_aug_random_und_full.h5'))
print(train_labels)
...
with open('und_train_full.pkl', 'wb') as f:
	pickle.dump(train_features, f)

with open('und_test_full.pkl', 'wb') as f:
	pickle.dump(test_features, f)

with open('und_trainl_full.pkl', 'wb') as f:
	pickle.dump(train_labels_r, f)

with open('und_testl_full.pkl', 'wb') as f:
