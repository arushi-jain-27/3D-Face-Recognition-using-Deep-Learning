...
def plot_roc(y_test,y_score):
	...
	plt.title('ROC curve: UND Aug21 NoSplit')
	plt.legend(loc='best')
	plt.savefig("roc_undAug21_noSplit.png")
...
with open('und_trainAug21_noSplit.pkl', 'rb') as f:
	train_points = pickle.load(f)

with open('und_testAug21_noSplit.pkl', 'rb') as f:
	test_points = pickle.load(f)

with open('und_trainlAug21_noSplit.pkl', 'rb') as f:
	train_labels = pickle.load(f)

with open('und_testlAug21_noSplit.pkl', 'rb') as f:
...
label_count = label_count[:257]
label_count_test = label_count_test[:257]
#print(train_labels)
...
for i in range(0,10):
    if i!=0: 
    	w_name = 'test_trainundAug21_noSplit'
    	model.load_weights(w_name, by_name=True)
