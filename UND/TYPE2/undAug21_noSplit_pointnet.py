...
train_points, train_labels = load_h5(os.path.join(path, 'data_aug21_und_orig_noSplit.h5'))
print(train_labels)
...
for i in range(0,25):
    if i!=0: 
    	w_name = 'undPointnetAug21_noSplit'
...
with open('und_trainAug21_noSplit.pkl', 'wb') as f:
	pickle.dump(train_features, f)

with open('und_testAug21_noSplit.pkl', 'wb') as f:
	pickle.dump(test_features, f)

with open('und_trainlAug21_noSplit.pkl', 'wb') as f:
	pickle.dump(train_labels_r, f)

with open('und_testlAug21_noSplit.pkl', 'wb') as f:
