...
train_points, train_labels = load_h5(os.path.join(path, 'data_aug_random_iiti_full.h5'))
print(train_labels)
...
total_samples = int(label_count_cum[169])
...
Y_train = np_utils.to_categorical(train_labels_r, 170)
Y_test = np_utils.to_categorical(test_labels_r, 170)
print(count1)
print(count2)
...
with open('intermediate_layer_iiti.pkl', 'wb') as f:
	pickle.dump(intermediate_layer_model, f)
...
with open('iiti_full_train.pkl', 'wb') as f:
	pickle.dump(train_features, f)

with open('iiti_full_test.pkl', 'wb') as f:
	pickle.dump(test_features, f)

with open('iiti_full_trainl.pkl', 'wb') as f:
	pickle.dump(train_labels_r, f)

with open('iiti_full_testl.pkl', 'wb') as f:
